...
4. Review structured data in a clear web UI (read-only by default) and **edit** pet and owner fields when needed (clinical summary is extraction-generated and read-only in v1)
