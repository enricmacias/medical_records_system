...
4. Review structured data in a clear web UI (read-only by default) and **edit** pet, owner, and medications when needed (clinical summary is extraction-generated and read-only in v1)
